...
//const Circle2 = new Circle(10, 'red');
...
const Product = class Product {
    constructor(string){
        ...
        this.price = Number(parameters[1]);
        this.availability = parameters[2];
    }
    ...
    static printProducts = (products) => {
        products.forEach(product => {
            if (product.availability === 'In Stock'){product.availability='Yes'
            } else {product.availability='No'};
            console.log(`Product: ${product.name}, Cost: ${new Intl.NumberFormat('en-US',{style: 'currency', currency: 'USD'}).format(product.price)}, Availability: ${product.availability}`);
        });
    }
};
